...
public class LevelSelectionState implements IState {
    ...
    public void init(IEngine e) {
        ...
        botonesNiveles[0][0] = new Button(volver, "4x4", e.getGraphics().getOriginalWidth() * (1 / 4.0f), e.getGraphics().getOriginalHeight() * 0.4f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);
        botonesNiveles[0][1] = new Button(volver, "5x5", e.getGraphics().getOriginalWidth() * (2 / 4.0f), e.getGraphics().getOriginalHeight() * 0.4f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);
        botonesNiveles[0][2] = new Button(volver, "5x10", e.getGraphics().getOriginalWidth() * (3 / 4.0f), e.getGraphics().getOriginalHeight() * 0.4f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);

        botonesNiveles[1][0] = new Button(volver, "8x8", e.getGraphics().getOriginalWidth() * (1 / 4.0f), e.getGraphics().getOriginalHeight() * 0.6f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);
        botonesNiveles[1][1] = new Button(volver, "10x10", e.getGraphics().getOriginalWidth() * (2 / 4.0f), e.getGraphics().getOriginalHeight() * 0.6f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);
        botonesNiveles[1][2] = new Button(volver, "10x15", e.getGraphics().getOriginalWidth() * (3 / 4.0f), e.getGraphics().getOriginalHeight() * 0.6f, e.getGraphics().getOriginalWidth() * 0.2f, e.getGraphics().getOriginalWidth() * 0.2f, 0X808080);
